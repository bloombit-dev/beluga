...
module Binja.Types.Core
  ( CSize (..),
    ...
    Binja.Types.DataVariable.DataVariable,
    Binja.Types.DataVariable.BNTypeWithConfidence,
    Binja.Types.DataVariable.BNBoolWithConfidence,
    Binja.Types.DataVariable.BNTypeClass,
    Binja.Types.DataVariable.BNTypePtr,
    BNMlilFunctionPtr,
...
import Binja.Types.DataVariable (BNBoolWithConfidence, BNTypeClass, BNTypePtr, BNTypeWithConfidence, DataVariable)
...
data AnalysisContext = AnalysisContext
  { -- | Binary View pointer which is the greatest common ancestor for all other types.
    ...
    symbols :: [Symbol],
    strings :: [String],
    dataVars :: [Binja.Types.DataVariable.DataVariable]
    -- image base :: Word64
    -- sections :: [Section]
    -- segments :: [Segment]
  }
